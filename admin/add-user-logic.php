...
if(isset($_POST['submit'])){
    ...
    if(!$firstname){
        ...
        if($createpassword !== $confirmpassword){
            ...
            // check if username or email alraedy exist in database
    ...
    if(isset($_SESSION['add-user'])){
        ...
        $insert_user_query = "INSERT INTO users SET firstname = '$firstname', lastname = '$lastname', username = '$username', email = '$email', password = '$hased_password', avatar = '$avatar_name', is_admin = $is_admin";
    ...
    // if button wasn'y clicked ,bounce back the signup page
    header('location: ' .ROOT_URL . 'admin/add-user.php');
    die();
}